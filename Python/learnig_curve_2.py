...
def experiment_1():
    """Performing analyzes and print
    results described in experiment 2 chapter"""
    
    df = pd.read_csv('analyses.csv')    
    df.fillna(0, inplace =True)
    targetLabels = df['fake_news']

    df.drop(['fake_news','news_no'
                ],axis=1, inplace=True)
    print("Processsing-------")
...
def experiment_2():
    """Performing analyzes and print
         results described in experiment 2 cahpter"""
    ...
    #dropp features after linear regrasion filtering
